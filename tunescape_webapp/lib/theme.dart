...
const lightColorScheme = ColorScheme(
  ...
  onTertiary: Color(0xFF064491),
  tertiaryContainer: Color(0xFF88A4EE),
  onTertiaryContainer: Color(0xFF0D41A5),
...
final lightTextScheme = TextTheme(
  ...
  bodyMedium: TextStyle(fontSize: 24.0, color: lightColorScheme.onPrimary),
